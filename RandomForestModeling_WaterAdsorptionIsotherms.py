...
# Defining and tuning the Random Forest model with more hyperparameters
param_grid = {'n_estimators': [1, 10, 50, 100, 200, 500, 1000, 5000, 10000],
...
metrics_table.to_excel("Random Forest modeling performance.xlsx")
...
for ax, label in zip(axs.flatten(), labels):
    ax.text(0.02, 0.95, label,
            ...
            va='top')
plt.tight_layout()
plt.savefig("RandomForestResults.tif", dpi=300, format="tif", bbox_inches="tight")
plt.show()